    ...
    return (
        <div className="my-8">
            ...
            <div className="md:flex gap-10">
                <div>
                    <img className="rounded-lg hover:scale-110 transition duration-300 ease-in-out " src="https://images.adsttc.com/media/images/6412/0d56/747d/5901/7042/0dce/newsletter/lumit-art-high-school-lukkairoinen-architects_4.jpg?1678904713" alt="" />
                ...
                <div className="">
                    <img className="rounded-lg  hover:scale-110 transition duration-300 ease-in-out" src="https://img.freepik.com/free-vector/flat-design-after-school-activities-webinar_23-2149645246.jpg" alt="" />
